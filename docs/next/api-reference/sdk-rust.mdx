...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `id` | `impl Into<String>` | Yes | Function identifier. |
| `registration` | [`RegisterFunction`](#registerfunction) | Yes | Built via [`RegisterFunction::new`], [`RegisterFunction::new_async`], or [`RegisterFunction::http`]. Chain `.description(...)`, `.metadata(...)`, `.request_format(...)`, `.response_format(...)` as needed. |
