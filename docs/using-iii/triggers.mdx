...
<Note>
  If you're authoring a worker, the same operation appears in [Creating Workers /
  Triggers](/creating-workers/triggers#bind-a-function-to-an-existing-trigger-type) where it sits
  next to the rest of the worker's startup work.
</Note>
